...
<body>
	...
	<div class="center-container">
		<div class="banner-dott">
			<div class="main">
				<h1 class="w3layouts_head">Edit Color</h1>
				<div class="w3layouts_main_grid">
					  {!! Form::open(array('route'=>array('color.update',$data['id']),'method'=>'PUT')) !!}
						{{ csrf_field() }}
						<input type="hidden" name="_token" value="{!! csrf_token() !!}">
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label> color </label>
								<input type="text" name="name" placeholder="Name" required="" value=" {!! old('name',isset($data) ? $data['color'] : null) !!} ">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
