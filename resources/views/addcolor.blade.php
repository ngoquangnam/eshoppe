...
<body>
	...
	<div class="center-container">
		<div class="banner-dott">
			<div class="main">
				<h1 class="w3layouts_head">Add Color</h1>
				<div class="w3layouts_main_grid">
					<h2 ><a class="hvr-outline-out button2" href="{{route('index')}}" style="color:white;text-decoration: none;">Shop Now </a><a class="hvr-outline-out button2" href="{{route('admin')}}" style="color:white;text-decoration: none;">| Admin</a></h2><br>
					<form action="{!! route('color.store') !!}" method="post" class="w3_form_post">
						{{ csrf_field() }}
