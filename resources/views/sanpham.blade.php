...
<link href="{{ asset('public/css/shoppy/style.css') }}" rel="stylesheet" type="text/css" media="all" />
									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
											<ul class="nav navbar-nav menu__list">
												<li class="active menu__item"><a class="menu__link" href="{{route('index')}}">Home <span class="sr-only">(current)</span></a></li>
													...
													<ul class="dropdown-menu multi-column columns-3">
														<div class="agile_inner_drop_nav_info">
															...
															<div class="col-sm-6 multi-gd-img multi-gd-text ">
																<a href="womens.html"><img src=" {{ asset('public/images/top1.jpg') }}"  alt=" "/></a>
															</div>
															<div class="clearfix"></div>
														</div>
													</ul>
													...
													<div class="banner-bootom-w3-agileits">
														<div class="container">
															<div class="col-md-4 single-right-left ">
																<div class="grid images_3_of_2">
																	<div class="flexslider">
																		...
																		<ul class="slides">
																			<li data-thumb="{{ asset('resources/upload/detail/'.$image1['image'] ) }} " >
																				<div class="thumb-image"> <img src="{{ asset('resources/upload/detail/'.$image1['image']) }}"  data-imagezoom="true" class="img-responsive"> </div>
																			</li>
																			<li data-thumb="{{ asset('resources/upload/'.$sanpham['image']) }}" >
																				<div class="thumb-image"> <img src="{{ asset('resources/upload/'.$sanpham['image']) }}"  data-imagezoom="true" class="img-responsive"> </div>
																			</li>	
																			<li data-thumb="{{ asset('resources/upload/detail/'.$image2['image'] ) }} " >
																				<div class="thumb-image"> <img src="{{ asset('resources/upload/detail/'.$image2['image']) }}"  data-imagezoom="true" class="img-responsive"> </div>
																			</li>
																		</ul>
																		<div class="clearfix"></div>
																	</div>	
															...
															<div class="col-md-8 single-right-left simpleCart_shelfItem">
																<h3>{!! $sanpham["name"] !!}</h3>
																<p><span class="item_price">${!! $sanpham["price"] !!}</span> <del>- $900</del></p>
																<div class="rating1">
																		...
																		<li><a href="#" class="twitter"> 
																					...
																					<div class="resp-tabs-container">
																						...
																						<div class="tab1">
																							...
																							<div class="single_page_agile_its_w3ls">
																								<h6>{!! $sanpham["discription"] !!}</h6>
																								
																								<p class="w3ls_para">{!! $sanpham["discription"] !!}</p>
																							</div>
																						</div>
																						<!--//tab_one-->
																						<div class="tab2">
																			...
																			<div class="w3_agile_latest_arrivals">
																				...
																				<div class="col-md-3 product-men single">
																					<div class="men-pro-item simpleCart_shelfItem">
																						<div class="men-thumb-item">
																							<img src=" {{ asset('public/images/w2.jpg') }}"  alt="" class="pro-image-front">
																							<img src=" {{ asset('public/images/w2.jpg') }}"  alt="" class="pro-image-back">
																				...
																				<div class="col-md-3 product-men single">
																					<div class="men-pro-item simpleCart_shelfItem">
																						<div class="men-thumb-item">
																							<img src=" {{ asset('public/images/w4.jpg') }}"  alt="" class="pro-image-front">
																							<img src=" {{ asset('public/images/w4.jpg') }}"  alt="" class="pro-image-back">
																							<div class="men-cart-pro">
																								<div class="inner-men-cart-pro">
																									<a href="single.html" class="link-product-add-cart">Quick View</a>
																								</div>
																				...
																				<div class="col-md-3 product-men single">
																					<div class="men-pro-item simpleCart_shelfItem">
																						<div class="men-thumb-item">
																							<img src=" {{ asset('public/images/s6.jpg') }}"  alt="" class="pro-image-front">
																							<img src=" {{ asset('public/images/s6.jpg') }}"  alt="" class="pro-image-back">
																							<div class="men-cart-pro">
																								<div class="inner-men-cart-pro">
																									<a href="single.html" class="link-product-add-cart">Quick View</a>
																								</div>
																				...
																				<div class="col-md-3 product-men single">
																					<div class="men-pro-item simpleCart_shelfItem">
																						<div class="men-thumb-item">
																							<img src=" {{ asset('public/images/w7.jpg') }}"  alt="" class="pro-image-front">
																							<img src=" {{ asset('public/images/w7.jpg') }}"  alt="" class="pro-image-back">
																							<div class="men-cart-pro">
																								<div class="inner-men-cart-pro">
																									<a href="single.html" class="link-product-add-cart">Quick View</a>
																								</div>
																		...
																		<div class="footer_agile_inner_info_w3l">
																			<div class="col-md-3 footer-left">
																				...
																				<ul class="social-nav model-3d-0 footer-social w3_agile_social two">
																					...
																					<!-- cart-js -->
																					<script src="{{ asset('public/js/minicart.min.js') }}"></script>
																					<script>
	// Mini Cart
